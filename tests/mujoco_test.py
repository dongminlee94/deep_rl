...
def main():
    ...
    if args.algo == 'trpo' or args.algo == 'ppo':
        ...
        mlp = MLP(obs_dim, act_dim, act_limit, hidden_sizes=(256,256), output_activation=torch.tanh, use_actor=True).to(device)
    elif args.algo == 'sac' or args.algo == 'asac' or args.algo == 'tac' or args.algo == 'atac':
        mlp = ReparamGaussianPolicy(obs_dim, act_dim, act_limit, hidden_sizes=(256,256)).to(device)
