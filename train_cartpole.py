...
# Configurations
parser = argparse.ArgumentParser(description='RL algorithms with PyTorch in CartPole-v1 environment')
...
def main():
    ...
    dir_name = 'runs/' + args.algo + '/' + 'CartPole-v1_' + time.ctime()
    ...
    for episode in range(1, args.training_eps+1):
        ...
        if episode > 0 and episode % args.eval_per_train == 0:
            ...
            if eval_average_return >= args.threshold_return:
                ...
                save_name = 'CartPole-v1_' + args.algo
